                    ...
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex">
                                ...
                                <button className="transition ease-in duration-300 inline-flex ml-auto items-center text-sm font-medium mb-2 md:mb-0 bg-purple-500 px-6 py-2 hover:shadow-lg tracking-wider text-white rounded-full hover:bg-purple-600 ">
